...
(setq find-function-C-source-directory
      (let ((dir (expand-file-name
                  (concat "~/data/share/" source-directory-base "src/"))))
...
(defadvice! *workspace-ask-before-deleting-a (&rest _)
  ...
  (if current-prefix-arg t
    (y-or-n-p
     (format "Really delete workspace (%s): " (+workspace-current-name)))))
#+end_src

#+begin_src emacs-lisp
(defadvice! *workspace-transient-map-on-display-a ()
...
Until [[github:emacs-evil/evil-collection/issues/386][#386]] is fixed, this disables the faulty =hungry-delete= module.
#+begin_src emacs-lisp
...
(defvaralias 'fbasic-indent-level 'indent-level)
#+end_src
...
#+begin_src emacs-lisp
(after! meson-mode
  (let ((dir (expand-file-name "~/data/share/meson-0.55.0/doc/")))
...
Use C-v to paste.
#+begin_src emacs-lisp
(map! :i "C-S-c" #'evil-yank
      :i "C-S-x" #'evil-delete
      :i "C-v" #'evil-paste-before
      :i "C-S-v" #'evil-paste-pop)
#+end_src
