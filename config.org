...
** Snippets
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :lexical yes
:END:
...
** Company
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref company-config
:END:
...
=<<evil-collection-config>>= right before ~+evil-collection-init~ first called.
#+BEGIN_SRC emacs-lisp :noweb no-export
...
*** Evil Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref evil-mode-config
:END:
...
*** Evil Collection
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref evil-collection-config
:END:

Nobody should be forced to play Tetris with HJKL.
#+BEGIN_SRC emacs-lisp
(push! +evil-collection-disabled-list 'tetris '2084-game)
#+END_SRC

#+BEGIN_SRC emacs-lisp
(push! +evil-collection-disabled-list 'haskell-error-mode)
#+END_SRC

*** Evil Numbers
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref evil-numbers-config
:END:

Remap the ~inc-at-pt~ functions, so =z == can be used for formatting.
#+BEGIN_SRC emacs-lisp
(map! :nv "g +" #'evil-numbers/inc-at-pt
...
*** Evil Snipe
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref evil-snipe-config
:END:
...
*** Evil Org
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref evil-org-config
:END:
...
** Flycheck
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref flycheck-config
:END:
...
Map double exclamation mark to buffer command.
#+BEGIN_SRC emacs-lisp
(map! :map flycheck-command-map "!" #'flycheck-buffer)
#+END_SRC
...
** Ivy
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref ivy-config
:END:
...
** Tab Bar
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref tab-bar-config
:END:
...
#+BEGIN_SRC emacs-lisp :tangle no :noweb no-export :noweb-ref
(when EMACS27+
  (after! tab-bar
    <<tab-bar-config>>))
#+END_SRC
...
** VTerm
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref vterm-config
:END:
...
*** ASM Mode Config
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref asm-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Basic Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref basic-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Arduino Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref arduino-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** C Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref c-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(when (featurep! :checkers syntax)
...
** Emacs Lisp
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref elisp-mode-config
:END:
...
(after! haskell-mode
  <<haskell-mode-config>>)
(after! dante
  <<haskell-dante-config>>)
#+END_SRC

*** Haskell Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref haskell-mode-config
:END:
...
#+BEGIN_SRC emacs-lisp
(after! flycheck (setq flycheck-hlint-args '("--no-exit-code")))
#+END_SRC
...
*** Dante
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref haskell-dante-config
:END:

#+BEGIN_SRC emacs-lisp
(after! flycheck (flycheck-add-next-checker 'haskell-dante '(warning . haskell-hlint)))
#+END_SRC
...
*** JS Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref js-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** TeX/LaTeX Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref tex-latex-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(after! which-key
...
*** Lua Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref lua-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
** Moonscript
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref moonscript-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb no-export :noweb-ref
(after! moonscript
  <<moonscript-mode-config>>)
#+END_SRC
...
*** Org Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref org-mode-config
:END:
...
*** Org Indent
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref org-indent-config
:END:
...
*** Org Keys
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref org-keys-config
:END:
...
*** Org Modules
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref org-modules-config
:END:
...
*** Org Source
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref org-src-config
:END:
...
(after! pascal
  <<pascal-mode-config>>
  <<pascal-and-opascal-mode-config>>)
...
*** Pascal Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref pascal-mode-config
:END:
...
*** OPascal Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref opascal-mode-config
:END:
...
*** Pascal and OPascal Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref pascal-and-opascal-mode-config
:END:
...
*** Perl Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref perl-mode-config
:END:
...
*** CPerl Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref cperl-mode-config
:END:
...
*** Perl and CPerl Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref perl-and-cperl-mode-config
:END:
...
*** PHP Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref php-mode-config
:END:
...
*** Python Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref python-mode-config
:END:
...
*** Company Jedi
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref company-jedi-config
:END:
...
#+BEGIN_SRC emacs-lisp
(use-package! company-jedi :commands company-jedi)
(set-company-backend! 'python-mode 'company-jedi)
#+END_SRC

*** _Backup
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref
:END:
...
*** Rustic Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref rustic-mode-config
:END:
...
*** Scheme Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref scheme-mode-config
:END:
...
*** Geiser Mode
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref geiser-mode-config
:END:
...
** Shell
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref sh-mode-config
:END:

#+BEGIN_SRC emacs-lisp :tangle yes :noweb yes :noweb-ref
(after! sh-script
  <<sh-mode-config>>)
#+END_SRC
...
** XML
:PROPERTIES:
:header-args:emacs-lisp: :tangle no :noweb-ref nxml-mode-config
:END:
