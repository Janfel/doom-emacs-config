...
#+BEGIN_SRC emacs-lisp
(when! (featurep! :editor fmt)
  (setq-hook! 'js-mode-hook +fmt-formatter #'prettier-format-region))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(when! (featurep! :editor fmt)
  (setq-hook! 'lua-mode-hook +fmt-formatter #'luaformatter-format-region))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(when! (featurep! :editor fmt)
  (setq-hook! 'python-mode-hook +fmt-formatter #'black-format-buffer))
#+END_SRC
