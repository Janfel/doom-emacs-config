...
#+LANGUAGE: en
#+STARTUP: fold
#+PROPERTY: header-args :noweb no-export :lexical yes :results silent :tangle yes
...
:PROPERTIES:
:header-args+: :tangle no :noweb-ref emacs-27-features
:END:
#+BEGIN_SRC emacs-lisp
...
** Tab Bar
:PROPERTIES:
:header-args+: :tangle no :noweb-ref tab-bar-config
:END:
...
** File Templates
:PROPERTIES:
:header-args+: :tangle no :noweb-ref file-templates-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(when (featurep! :editor file-templates)
  <<file-templates-config>>)
#+END_SRC
...
*** Indent Guides
:PROPERTIES:
:header-args+: :tangle no :noweb-ref highlight-indent-guides-config
:END:
...
*** VTerm
:PROPERTIES:
:header-args+: :tangle no :noweb-ref vterm-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
** Company
:PROPERTIES:
:header-args+: :tangle no :noweb-ref company-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
*** Evil Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref evil-mode-config
:END:
...
*** Evil Collection
:PROPERTIES:
:header-args+: :tangle no :noweb-ref evil-collection-config
:END:
...
*** Evil Numbers
:PROPERTIES:
:header-args+: :tangle no :noweb-ref evil-numbers-config
:END:
...
*** Evil Snipe
:PROPERTIES:
:header-args+: :tangle no :noweb-ref evil-snipe-config
:END:
...
*** Evil Org
:PROPERTIES:
:header-args+: :tangle no :noweb-ref evil-org-config
:END:
...
** Flycheck
:PROPERTIES:
:header-args+: :tangle no :noweb-ref flycheck-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
(map! :map flycheck-mode-map :prefix "C-c"
      (:prefix ("!" . "flycheck") "" flycheck-command-map))
#+END_SRC
...
** Ivy
:PROPERTIES:
:header-args+: :tangle no :noweb-ref ivy-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
** Smartparens
:PROPERTIES:
:header-args+: :tangle no :noweb-ref smartparens-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
** Which Key
:PROPERTIES:
:header-args+: :tangle no :noweb-ref which-key-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! which-key
  <<which-key-config>>
...
*** Replacements
:PROPERTIES:
:header-args+: :tangle no :noweb-ref which-key-replacements
:END:
...
** Yasnippet
:PROPERTIES:
:header-args+: :tangle no :noweb-ref yasnippet-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
...
** Arduino
:PROPERTIES:
:header-args+: :tangle no :noweb-ref arduino-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! arduino
  <<arduino-mode-config>>)
...
** Assembler
:PROPERTIES:
:header-args+: :tangle no :noweb-ref asm-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! asm-mode
  <<asm-mode-config>>)
...
** BASIC
:PROPERTIES:
:header-args+: :tangle no :noweb-ref basic-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! basic-mode
  <<basic-mode-config>>)
...
*** C Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref c-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(when (featurep! :checkers syntax)
...
*** Sly
:PROPERTIES:
:header-args+: :tangle no :noweb-ref lisp-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Haskell Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref haskell-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
(add-hook! 'haskell-mode-hook (run-hooks 'haskell-mode-local-vars-hook))
#+END_SRC
...
*** Dante
:PROPERTIES:
:header-args+: :tangle no :noweb-ref haskell-dante-config
:END:
#+BEGIN_SRC emacs-lisp
...
** JavaScript :Web:
:PROPERTIES:
:header-args+: :tangle no :noweb-ref js-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! js
  <<js-mode-config>>)
...
*** TeX/LaTeX Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref tex-latex-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(after! which-key
...
*** Lua Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref lua-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Company Lua
:PROPERTIES:
:header-args+: :tangle no :noweb-ref company-lua-config
:END:
#+BEGIN_SRC emacs-lisp
...
** MoonScript :Lua:
:PROPERTIES:
:header-args+: :tangle no :noweb-ref moonscript-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! moonscript
...
*** Org Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref org-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Org Indent
:PROPERTIES:
:header-args+: :tangle no :noweb-ref org-indent-config
:END:
...
*** Org Keys
:PROPERTIES:
:header-args+: :tangle no :noweb-ref org-keys-config
:END:
...
*** Org Modules
:PROPERTIES:
:header-args+: :tangle no :noweb-ref org-modules-config
:END:
...
*** Org Source
:PROPERTIES:
:header-args+: :tangle no :noweb-ref org-src-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Pascal Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref pascal-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** OPascal Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref opascal-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
:PROPERTIES:
:header-args+: :tangle no :noweb-ref pascal-and-opascal-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(when (featurep! :editor fmt)
...
*** Perl Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref perl-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** CPerl Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref cperl-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Perl and CPerl Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref perl-and-cperl-mode-config
:END:
#+BEGIN_SRC emacs-lisp
(when (featurep! :editor fmt)
...
*** PHP Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref php-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Python Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref python-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
*** Company Jedi
:PROPERTIES:
:header-args+: :tangle no :noweb-ref company-jedi-config
:END:
...
*** Rustic Mode
:PROPERTIES:
:header-args+: :tangle no :noweb-ref rustic-mode-config
:END:
#+BEGIN_SRC emacs-lisp
...
** Shell
:PROPERTIES:
:header-args+: :tangle no :noweb-ref sh-mode-config
:END:
#+BEGIN_SRC emacs-lisp :tangle yes :noweb-ref
(after! sh-script
  <<sh-mode-config>>)
...
** XML
:PROPERTIES:
:header-args+: :tangle no :noweb-ref nxml-mode-config
:END:
